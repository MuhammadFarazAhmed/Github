...
@Serializable
data class RepoModelRemote(val list: List<GithubRepoModelItem>) {
    @Entity
    @Serializable
...
data class RepoModelLocal(
    @PrimaryKey val id: Int = 0,
    val nodeId: String? = null,
    val name: String? = null,
)

fun RepoModelRemote.GithubRepoModelItem.toLocalRepo() = RepoModelLocal(id, nodeId, name)